...
avg_metrics = function(n_vec=c(100),p_vec=c(100),graph_vec=c("random"),rep_vec=c(1:50),thin=100,plot=FALSE){
  #determine number of 
    ...
    for (n in n_vec){
      for (graph in graph_vec){
        for (rep in rep_vec){
            ...
            #mpl bd method - collect data and calculate AUC,CE,SVAUC and time
            ...
            #mpl rj method - collect data and calculate AUC,CE,SVAUC and time
            ...
            #bd method - collect data and calculate AUC,CE,SVAUC and time
            ...
            #rj method - collect data and calculate AUC,CE,SVAUC and time
            ...
            #ss method - collect data and calculate AUC,CE,SVAUC and time
