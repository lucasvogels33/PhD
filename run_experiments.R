...
t1_mpl_bd      = proc.time()	
sample_mpl_bd  = bdgraph.mpl( data = data.sim, algorithm = "bdmcmc", iter = iter, burnin = burnin, jump = jump, save = save,cores=cores,g.start=g.start)
...
t1_bd_app      = proc.time()	
sample_bd_app  = bdgraph( data = data.sim, algorithm = "bdmcmc", iter = iter, burnin = burnin, jump = jump, save = save,cores=cores,g.start=g.start)
...
t1_rj_app      = proc.time()	
sample_rj_app  = bdgraph( data = data.sim, algorithm = "rjmcmc", iter = iter, burnin = burnin, jump = jump, save = save,cores=cores,g.start=g.start)
