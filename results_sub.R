...
load_results = function(p=5,graph="random",n=10,round=2,iter_rep=10)
{
    ...
    filename = paste0(graph,"_output_all")
    ...
    for (i in 1:iter_rep){
        ...
        cat("auc of rep ",i," of the mpl_bd method is ",auc_mpl_bd[i]," ", file = filename,"\n", append = TRUE)
        cat("time of rep ",i," of the mpl_bd method is ",time_mpl_bd[i]," ", file = filename,"\n", append = TRUE)
